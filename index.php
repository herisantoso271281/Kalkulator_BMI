			...
			<div class="wrap-contact3">
				...
				<!-- 	<div class="wrap-contact3-form-radio">
					...
					<div class="wrap-input3 validate-input" >
						<input class="input3" type="text" name="berat" placeholder="berat" value="<?php if(!empty($_POST['berat'])){ echo $_POST['berat']; }?>" required>
						<span class="focus-input3"></span>
					</div>

					<div class="wrap-input3 validate-input" >
						<input class="input3" type="text" name="tinggi" placeholder="tinggi" value="<?php if(!empty($_POST['tinggi'])){ echo $_POST['tinggi']; }?>" required>
						<span class="focus-input3"></span>
					</div>
					...
					<div class="wrap-input3 validate-input" >
						<?php
								...
								?>
						<textarea class="input3" name="message" placeholder="Your Message"><?php echo "$bmi" ; ?></textarea>
						<span class="focus-input3"></span>
					</div>
